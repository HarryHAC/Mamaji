...
/*
 * All spoken/shown phrases for the Mama Ji voice assistant, in the four
 * supported languages: ne (Nepali), en (English), mai (Maithili), bho (Bhojpuri).
 * Dynamic phrases are functions; static ones are objects passed to pick().
 */
...
export const AGENT = {
  ...
  // Asked after the customer confirms the order — pick a payment method by voice.
  ...
  // Localized label for a payment method (used in the success message).
  payLabel: (language, method) => {
    const labels = {
      cod: { ne: 'नगद (डेलिभरीमा)', en: 'Cash on Delivery', mai: 'नगद (डेलिभरीमे)', bho: 'नगद (डेलिभरी पर)' },
      esewa: { ne: 'eSewa (अनलाइन — भुक्तानी भयो)', en: 'eSewa (Online — Paid)', mai: 'eSewa (अनलाइन — भुगतान भेल)', bho: 'eSewa (अनलाइन — भुगतान भइल)' },
      khalti: { ne: 'Khalti (अनलाइन — भुक्तानी भयो)', en: 'Khalti (Online — Paid)', mai: 'Khalti (अनलाइन — भुगतान भेल)', bho: 'Khalti (अनलाइन — भुगतान भइल)' }
    };
  ...
  noOrderReady: (language) => pick(language, {
    ne: 'कुनै अर्डर तयार छैन।',
    en: 'No order ready to confirm.',
    mai: 'कोनो अर्डर तैयार नै अछि।',
    bho: 'कवनो आर्डर तैयार नइखे।'
  }),
  ...
  noActiveOrder: (language) => pick(language, {
    ne: 'अहिले कुनै सक्रिय अर्डर छैन।',
    en: 'No active orders found right now.',
    mai: 'एखन कोनो सक्रिय अर्डर नै अछि।',
    bho: 'अभी कवनो सक्रिय आर्डर नइखे।'
  }),
  ...
  cancelAck: (language) => pick(language, {
    ne: 'ठीक छ। तपाईंलाई केही चाहियो भने भन्नुहोस्।',
    en: 'Sure. Let me know if you need anything.',
    mai: 'ठीक अछि। किछु चाही त कहू।',
    bho: 'ठीक बा। कुछु चाहीं त कहीं।'
  }),
